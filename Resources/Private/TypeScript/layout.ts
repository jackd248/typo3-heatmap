...
export class HeatmapLayoutCalculator {
  ...
  private isSquareWidget: boolean;
  private isSmallWidget: boolean;
  ...
  public calculate(): HeatmapLayout {
  ...
  private calculateSingleRowLayout(weekCount: number): HeatmapLayout {
    const rows = 1;
  ...
  private calculateOffsets(layout: HeatmapLayout): void {
